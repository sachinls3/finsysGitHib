...
Feature: Create Company
  ...
  Scenario: Create Company with all valid inputs
    ...
    And user enters Company Name as "TestCompanySachinS35"
    ...
    Then new company gets created and listed on the first row of the first page as "TestCompanySachinS35"
